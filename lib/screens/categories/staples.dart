...
class StaplesScreen extends StatefulWidget {
  ...
  @override
  _StaplesScreenState createState() => _StaplesScreenState();
}
...
class _StaplesScreenState extends State<StaplesScreen> {
  ...
  void _loadAllProducts() async {
    ...
    List<String> categories = ['Jasmine Rice', 'Spaghetti', 'Orzo', 'Basmati Rice', 'Penne'];
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Row(
                children: ['Jasmine Rice', 'Spaghetti', 'Orzo', 'Basmati Rice', 'Penne']
