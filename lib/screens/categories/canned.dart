...
class CannedScreen extends StatefulWidget {
  ...
  @override
  _CannedScreenState createState() => _CannedScreenState();
}
...
class _CannedScreenState extends State<CannedScreen> {
  ...
  void _loadAllProducts() async {
    ...
    List<String> categories = ['Black Beans', 'Corn', 'Coconut Milk', 'Tomato Paste', 'Tuna'];
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Row(
                children: ['Black Beans', 'Corn', 'Coconut Milk', 'Tomato Paste', 'Tuna']
